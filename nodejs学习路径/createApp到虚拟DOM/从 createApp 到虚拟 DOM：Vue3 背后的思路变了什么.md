...
![[nodejs学习路径/createApp到虚拟DOM/1.png]]
...
![[nodejs学习路径/createApp到虚拟DOM/2.png]]
...
1. **创建应用实例**
![[nodejs学习路径/createApp到虚拟DOM/3.png]]
...
3. **挂载** `app.mount('#app')` 
  ...
  ```
 它做了三件事
 ![[nodejs学习路径/createApp到虚拟DOM/4.png]]
 图中第三点举例
...
![[nodejs学习路径/createApp到虚拟DOM/5.png]]
...
![[nodejs学习路径/createApp到虚拟DOM/6.png]]

diff 两棵树节点分别对比
![[nodejs学习路径/createApp到虚拟DOM/7.png]]

**patch** 只更新那一个真实 DOM
![[nodejs学习路径/createApp到虚拟DOM/8.png]]

再看总流程

![[nodejs学习路径/createApp到虚拟DOM/9.png]]
